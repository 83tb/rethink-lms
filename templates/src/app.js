    ...
    function($scope, $location, $timeout, $http, olData, olHelpers, adjsServis) {
                ...
                isValidBounds: function(bounds) {
                    return angular.isDefined(bounds) && (
                        ...
                        (angular.isArray(bounds) && bounds.length === 4 &&
                            ...
                            angular.isArray(bounds[3]) && bounds[3].length === 2 && angular.isNumber(bounds[3][0]) && angular.isNumber(bounds[3][1]) && bounds[3][1] > 1
                        )
                    );
                },
        ...
        $scope.setExt = function() {
            olData.getMap().then(function(map) {
                var extent = [
                    [20.63249140, 52.12195456],
                    [20.61395197, 52.13565408],
                    [20.67540675, 52.15482633],
                    [20.69772272, 52.13691844]
                ];
